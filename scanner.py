...
def find_open_ports():
    try:
        if args.top1000: #Perform List of Port Scan
...
if __name__ == '__main__':
    ...
    if args.top1000: #Perform top 1000 ports scan
            port_list = top1000
